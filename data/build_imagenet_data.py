...
tf.app.flags.DEFINE_string('train_directory', 'img_data/img/train',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', 'img_data/img/validation',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', 'img_data/output2',
                           'Output data directory')

tf.app.flags.DEFINE_integer('train_shards', 50,
