...
OUTDIR="/work/d122/d122/s1245946/ml/data/data/raw-data"
SYNSETS_FILE="/work/d122/d122/s1245946/ml/data/imagenet_lsvrc_2015_synsets.txt"
...
TRAIN_TARBALL="${OUTDIR}/train/ILSVRC2012_img_train.tar"
...
while read SYNSET; do
  ...
  tar -xvf "${TRAIN_TARBALL}" "${SYNSET}.tar"
  tar -xvf "${SYNSET}.tar" -C "${OUTPUT_PATH}/${SYNSET}/"
  rm -f "${SYNSET}.tar"
