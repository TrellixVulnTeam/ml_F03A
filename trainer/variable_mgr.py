...
class VariableMgr(object):
    ...
    def append_apply_gradients_ops(self, gradient_state, opt, grads, training_ops):
        ...
        :param gradient_state: from previous call to apply_gradients_devices.
        :param opt: the underlying optimizer
        :param grads: [(grad, var)] to apply
        :param training_ops: list to which to add ops
        """
    ...
    def trainable_variables_on_device(self, device_num, writable=False):
        ...
        :param device_num: the index to the device.
        :param writable: whether to get a reference to the underlying variable.
        :return The set of trainable vairalbes on the specified device.
        """
        del writable
...
class StagedModelVariable(object):
    ...
    def __init__(self, real_var, var_stage_get, variable_mgr):
        ...
        :param real_var: the underlying real variable.
        :param var_stage_get: the read op from the staging buffer.
        :param variable_mgr: the parent variable-manager.
        """
